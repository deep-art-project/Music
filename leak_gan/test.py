...
def test_generator():
    ...
    for i, sample in enumerate(dataloader):
        ...
        # Test pre.
        pre_rets = recurrent_func("pre")(model_dict, sample)
        ...
        # Test adv.
        adv_rets = recurrent_func('adv')(model_dict)
        ...
        # Test gen.
        gen_token = recurrent_func("gen")(model_dict)
        print("gen_token:{}".format(gen_token.size()))
...
def test_loss_func():
    ...
    for i, sample in enumerate(dataloader):
        ...
        rewards = get_rewards(model_dict, gen_token, 4)
